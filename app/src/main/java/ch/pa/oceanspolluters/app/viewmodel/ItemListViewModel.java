...
public class ItemListViewModel extends AndroidViewModel {
    ...
    private final MediatorLiveData<List<ItemEntity>> mObservableItems;
    ...
    private ItemListViewModel(@NonNull Application application,
        ...
        LiveData<List<ItemEntity>> ItemsFromContainer = ItemRepository.getItemsFromContainerLD(containerId);
     ...
     */
    public LiveData<List<ItemEntity>> getContainerItems() {
